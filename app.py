...
# Custom High-End Modern CSS Styling (No raw HTML leaks, safe text wrap, no ellipsis truncation)
st.markdown("""
<style>
...
if output:
    ...
    # Clean, beautiful, uncollapsed spec box with zero truncation and zero HTML bugs
